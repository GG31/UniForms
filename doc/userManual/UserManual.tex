...
\noindent\begin{minipage}{\linewidth}% to keep image and caption on one page
\makebox[\linewidth]{%        to center the image
  \includegraphics [width=150mm]{images/destinataires.png}}
\captionof{figure}{Zone de destinataires}\label{destinataires}
\end{minipage}
...
\noindent\begin{minipage}{\linewidth}% to keep image and caption on one page
\makebox[\linewidth]{%        to center the image
  \includegraphics [width=150mm]{images/destinatairesCheckbox.png}}
\captionof{figure}{Zone de destinataires}\label{destinatairesCheckbox}
\end{minipage}
...
\noindent\begin{minipage}{\linewidth}% to keep image and caption on one page
\makebox[\linewidth]{%        to center the image
  \includegraphics [width=150mm]{images/consultResult.png}}
