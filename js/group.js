...
moreGroup = function() {
   ...
   newNode = $('<div class="row" id="group_'+nb+'">							   <div class="panel panel-default col-sm-8">						         <div class="panel-body">                              <div class="groupElements" style="height: 50px;"></div>                           </div>                        </div>                        <button type="button" class="btn btn-default btn-lg">                              <span class="glyphicon glyphicon-envelope" ariahidden="true"></span>                        </button>                        <button type="button" class="btn btn-default btn-lg" onclick="lessGroup(\'group_'+nb+'\')">                              <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>                        </button>                     </div>                     	</div>						');
