...
class Form {
	...
	public function getListRecipient($ids, $state){
		$res = [];
		if($state == 0){
			$res[] = ["FormDestId" => 63, "User" => new User(1), "Status" => FALSE, "Answer" => new Answer(63)];//new Answer(63)
			$res[] = ["FormDestId" => 64, "User" => new User(1), "Status" => FALSE, "Answer" => new Answer(63)];
			$res[] = ["FormDestId" => 65, "User" => new User(1), "Status" => FALSE, "Answer" => new Answer(63)];//new Answer(65)
		}else{
